...
class AutoCrawler:
    ...
    @staticmethod
    def get_keywords(keywords_file='/home/at05/PycharmProjects/smh_restart/test.txt'):
    ...
    def download_images(self, keyword, links, site_name):
        ...
        for index, link in enumerate(links):
            try:
                print('Downloading {} fron {}: {} / {}'.format(keyword, site_name, index + 1, total))
                response = requests.get(link, stream=True)
                ext = self.get_extension_from_link(link)
                self.save_image_to_file(response, '{}/{}/{}_{}.{}'.format(self.download_path, keyword, site_name,
                                                                          str(index).zfill(4), ext))
                del response
            except Exception as e:
    ...
    def download_from_site(self, keyword, site_code):
        ...
        try:
            ...
            print('Downloading images from collectes links... {} from {}'.format(keyword, site_name))
